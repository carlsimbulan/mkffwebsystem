            ...
            <div className="modal-dialog modal-dialog-centered modal-lg">
                <div className="modal-content border-0 rounded-4 overflow-hidden shadow-none">
                    ...
                    <div className="modal-body p-4 bg-light bg-opacity-50">
                        {error && (
                            <div className="alert alert-danger border-0 rounded-3 small fw-bold uppercase mb-4">
                        ...
                        <div className="bg-white border rounded-4 p-4 shadow-sm">
                            <div className="mb-4">
                                ...
                                <select 
                                    className="form-select border-2 shadow-none fw-bold text-dark" 
                                    name="station" 
                            ...
                            <div className="row g-3 mb-4">
                                <div className="col-md-4">
                                    <div className="bg-light p-3 rounded-3 border border-primary border-opacity-10">
                                        ...
                                        <input 
                                            type="number" 
                                            className="form-control form-control-lg border-0 bg-transparent fw-black p-0 shadow-none text-primary" 
                                            name="total_units_processed" 
                                            value={formData.total_units_processed} 
                                            onChange={handleChange} 
                                            placeholder="0" 
                                            required 
                                        />
                                ...
                                <div className="col-md-4">
                                    <div className="bg-light p-3 rounded-3 border border-danger border-opacity-10">
                                        ...
                                        <input 
                                            type="number" 
                                            className="form-control form-control-lg border-0 bg-transparent fw-black p-0 shadow-none text-danger" 
                                            name="total_ng" 
                                            value={formData.total_ng} 
                                            onChange={handleChange} 
                                            placeholder="0" 
                                        />
                                    </div>
                                ...
                                <div className="col-md-4">
                                    <div className="bg-light p-3 rounded-3 border">
                                        ...
                                        <input 
                                            type="number" 
                                            className="form-control form-control-lg border-0 bg-transparent fw-black p-0 shadow-none text-dark" 
                            ...
                            <div className="mb-4">
                                ...
                                <textarea 
                                    ...
                                    placeholder="Provide technical details, machine issues, or part shortages..."
                                ></textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="p-3 border-2 border-dashed rounded-3 bg-light text-center" style={{ borderColor: '#cbd5e1' }}>
                                    ...
                                    />
                                    {filePreview && (
                                        <p className="text-primary fw-bold small mt-2 mb-0 uppercase">
                                            <i className="bi bi-check-circle-fill me-1"></i> File ready: {filePreview}
                                        </p>
                                    )}
                                </div>
                            </div>
                    ...
                    <div className="modal-footer bg-white border-top py-3 px-4">
                        <button 
                            type="button" 
                            className="btn btn-light border btn-sm fw-bold px-4 rounded-pill me-auto shadow-none" 
                            onClick={onClose}
                        >
                            DISCARD
                        </button>
