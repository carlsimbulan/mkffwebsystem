...
const DEFAULT_AVATAR_PATH_PLACEHOLDER = 'data:image/svg+xml;base64,-MS4zLjRjLS4xLjQtLjIuOS0uMyAxLjItLjQuNy0uNSAxLjQtLjUgMi4yIDAgLjcuMyAxLjMuOSAxLjguNC0uMi43LS41IDEtLjkuNS0uNS43LTEuMS43LTEuOCAwLS45IDAtMS43LS41LTIuNC0uNS0uNi0xLjMtMS0xLjgtMS4yLS4xLjMtLjIuNi0uNCAxeiIvPjwvc3ZnPg==';
...
export const ManageUserModal = ({ 
    ...
    const initialFormData = isEditMode ? {
        ...
        id: null,
        username: DOMAIN, // Set default domain for new users
        password: '',
        role: 'Operator',
        full_name: '',
        station: '',
    ...
    const handleChange = (e) => {
        ...
        // Logic for Username: Force the @mkff.com suffix
        if (name === 'username') {
    ...
    const handleSave = async () => {
        // Basic Validation
        if (!formData.username || formData.username === DOMAIN || !formData.password || !formData.role || !formData.full_name) {
            setError('Please provide a username and all required fields.');
            return;
        }
                                    ...
                                    <div className="card shadow-sm border-0 rounded-3 bg-white p-4">
                                        ...
                                        <div className="row">
                                            <div className="col-md-6 mb-3">
                                                <label className="form-label fw-bold small">Username / Email</label>
                                                <input 
                                                    type="text" 
                                                    ...
                                                    required 
                                                />
                                                <div className="form-text x-small text-muted">Auto-appends @mkff.com</div>
                                            </div>
                                        ...
                                        <h6 className="fw-bold text-uppercase small text-muted mb-3 pb-2 border-bottom mt-4">Access & Station</h6>
