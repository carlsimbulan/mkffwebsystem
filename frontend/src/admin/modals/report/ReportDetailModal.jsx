    ...
    return (
        <div className="modal show d-block" style={{ backgroundColor: 'rgba(0, 0, 0, 0.5)', zIndex: 1060, backdropFilter: 'blur(5px)' }}>
            <style>{`
                ...
                .report-label { font-size: 0.7rem; font-weight: 800; color: #64748b; text-transform: uppercase; letter-spacing: 1px; }
                .report-value { font-size: 1.1rem; font-weight: 700; color: #0f172a; }
                /* UI Only Box */
                .summary-box { background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 20px; min-height: 150px; }
                .print-only { display: none; }

                @media print {
                    @page { 
                        size: portrait; 
                        margin: 10mm; /* Mas pinalit na margin para di sayang sa papel */
                    }
                    ...
                    .print-meta-item { font-size: 1rem; margin-bottom: 2px; text-transform: uppercase; font-weight: bold; }
                    
                    /* Content Style - No Containers */
                    ...
                    /* Siguradong walang background color o border na lalabas sa print */
                    .summary-box { 
                        padding: 0 !important; 
                        border: none !important; 
                        background: none !important;
            ...
            <div className="modal-dialog modal-dialog-centered modal-lg">
                <div className="modal-content border-0 rounded-4 shadow-lg print-area">
                    ...
                    <div className="modal-body p-4 bg-white">
                        ...
                        <div className="row g-4 mb-4 no-print">
                            ...
                            <div className="col-md-4">
                                ...
                                <div className="report-value">{report.total_units_processed} / <span className="text-danger">{report.total_ng}</span></div>
                            </div>
                        </div>
                        ...
                        {attachmentUrl && (
                            <div className="mt-4 no-print">
                                <a href={attachmentUrl} target="_blank" rel="noopener noreferrer" className="btn btn-sm btn-outline-primary fw-bold">
                    ...
                    <div className="modal-footer border-top bg-light px-4 py-3 no-print">
                        ...
                        <button className="btn btn-primary fw-bold px-4" onClick={onClose}>
                            Close
                        </button>
                    </div>
                </div>
